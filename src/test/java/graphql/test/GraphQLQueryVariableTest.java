...
//
//public class GraphQLQueryVariableTest {
//
//    @Test
//    public void testAllUsersWithQueryVariables() {
...
//        variable.setLimit(1);
//        variable.setName("akshayapsangi123");
...
//                .statusCode(200)
//                .and()
//                .body("data.users",hasSize(variable.getLimit()))
//                .body("data.users[0].name",equalTo(variable.getName()));
//
//    }
//}
