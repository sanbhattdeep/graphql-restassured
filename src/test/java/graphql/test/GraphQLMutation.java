...
public class GraphQLMutation {
        ...
        @Test
        public void testInsertToDoMutation() {
                GraphQLQuery query = new GraphQLQuery();
                query.setQuery("mutation($title:String!) {\n" +
                ...
                given()
                        ...
                        .statusCode(200)
                        .and()
                        .body("data.insert_todos.returning[0].title",equalTo(variable.getTitle()));
         }
  }
